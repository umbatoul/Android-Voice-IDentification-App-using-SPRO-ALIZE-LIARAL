...
#ifdef __ANDROID_API__
  //   __android_log_print(ANDROID_LOG_DEBUG, "Mixture", "  &&&&&&&  dc=   %lu  \n", distribCount);
  //   __android_log_print(ANDROID_LOG_DEBUG, "Mixture", "  &&&&&&&  v=   %lu  \n", v);
  //   __android_log_print(ANDROID_LOG_DEBUG, "Mixture", "  &&&&&&&  id=   %s  \n", id.c_str());
#endif
   //#else 
   printf("Mixture .... dc=%lu\n",distribCount);
   printf("Mixture .... v=%lu\n",v);
   printf("Mixture .... id=%s\n",id.c_str());
   //#endif
...
#ifdef __ANDROID_API__
  //   __android_log_print(ANDROID_LOG_DEBUG, "EqualizeWeight", "  &&&&&&&  n=   %lu  \n", n);
#else 
   printf("EqualizeWeight .... n=%lu\n",n);
#endif
...
#ifdef __ANDROID_API__
    //    __android_log_print(ANDROID_LOG_DEBUG, "EqualizeWeight", "  &&&&&&&  w=   %f  \n", w);
#else 
   printf("EqualizeWeight W .... w=%f\n",w);
#endif
...
{ cout<<"IAMHERE"<<endl; MixtureFileWriter(f, c).writeMixture(*this); }
//-------------------------------------------------------------------------
...
{
#ifdef __ANDROID_API__
  //  __android_log_print(ANDROID_LOG_DEBUG, "Mixture", "-computeall Constructor \n");
#else
   printf("Mixture -computeall Constructor \n");
#endif
