...
// #ifdef __ANDROID_API__
//     __android_log_print(ANDROID_LOG_DEBUG, "FrameAccGD", "-COMPAALL, mean=%f; accVect[%lu]=%f, invCount=%f; \n", mean, i, accVect[i], invCount);
// #else
//    printf("FrameAccGD -COMPAALL, mean=%f; accVect[%lu]=%f, invCount=%f; \n", mean, i, accVect[i], invCount);
// #endif
