...
{
  //    __android_log_print(ANDROID_LOG_DEBUG, "LOADCLUSTERFILE", "QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQqs:  \n");
...
unsigned long FeatureFileList::getFeatureCount(unsigned long fileIdx) const
{
  ...
  //    __android_log_print(ANDROID_LOG_DEBUG, "LOADCLUSTERFILE", "OHOHOHOHOHOHOHOHOHOHOHOOHOHOHOHOOHOHOHOHOOHOHOHOHOqs:  \n");
...
unsigned long FeatureFileList::getFeatureCount(const FileName& f) const
{
  ...
  //    __android_log_print(ANDROID_LOG_DEBUG, "LOADCLUSTERFILE", "HIHOHIHOHIHOHIHOHIHOHIHOHIHOHIHOHIHO:  \n");
