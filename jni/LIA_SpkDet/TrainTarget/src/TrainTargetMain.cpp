...
extern "C" {
jint Java_com_example_VoiceRecognize_VoiceRecognize_TrainTarget1(JNIEnv* env,
								 jobject thiz,
...
#include "jniXcommon.hpp" 
 ...
 try{
    ...
    { 
      cout <<"TrainTarget "<< e.toString() << endl << cc.getParamList()<<endl;
#ifdef __ANDROID_API__
      __android_log_print(ANDROID_LOG_DEBUG, "CompTestMain", "Exception[%s]\n%s\n",
			  e.toString().c_str(),
			  cc.getParamList().c_str());
#endif
    }
    return 0;
