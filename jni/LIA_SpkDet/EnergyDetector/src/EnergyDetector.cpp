...
//   __android_log_print(ANDROID_LOG_DEBUG, "EnergyDetector", "Proceeding Energy based silence detection for [%s]\n", featureFileName.c_str());
...
//     __android_log_print(ANDROID_LOG_DEBUG, "EnergyDetector", "Partial Train it[%d] (-1 means initial partial it) LLK=%f  Nb Frames=%f \n", trainIt-1, llkPreviousIt, emAcc.getEMFeatureCount());
