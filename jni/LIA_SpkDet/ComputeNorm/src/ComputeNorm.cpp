...
bool DistribNorm::computeMeanStd(double &mean,double &std,char mode, double percentH,double percentL){
        if(tabScore.size() == 0) {
// #ifdef __ANDROID_API__
// 	  __android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "size ****************************** [%lu]\n",tabScore.size());
// #else
	  printf("CompNorm size [%lu]\n",tabScore.size());
// #endif
...
#ifdef __ANDROID_API__
					//	__android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "mean= %f \n size-sqr[mean] = %f\n std= %f\n", mean,(double)(size)-(mean*mean), std );
#else
					printf("CompNorm mean= %f \n size-sqr[mean] = %f\n std= %f\n", mean,(double)(size)-(mean*mean), std );
#endif
...
#ifdef __ANDROID_API__
		__android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "Problem: empty impostor cohort\n");
#endif
...
// #ifdef __ANDROID_API__
// 		__android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "MEAAAAAAAAAAAAAAAAAAAAAAN=%f\n", mean);
// #endif
...
NormSeg::NormSeg(){
         computed = false; // initializingggg!!!!!
...
// #ifdef __ANDROID_API__
// 		__android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "Name [%s] Mean = [%f] Std =[%f]\n", normTab[i].getName().c_str(), getMean(i), getStd(i));
// #endif
...
#ifdef __ANDROID_API__
		__android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "Table norm Capacity out of bound: %lu\n", nbNorm);
#endif
...
// #ifdef __ANDROID_API__
// 		__android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "NAME  FFFFFFFFFFFFFFFFFFFFFFF: %s\n", name.c_str());
// #endif
...
// #ifdef __ANDROID_API__
// 	__android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "addSeg name %s mean %f std %f\n", name.c_str(), mean, std);
// #endif
...
#ifdef __ANDROID_API__
				__android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "distrbution for [%s] not found!\n ", fieldTwo.c_str());
#endif
...
// #ifdef __ANDROID_API__
// 		__android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "Tnorm, reading tnormList\n");
// #endif
...
// #ifdef __ANDROID_API__
// 		__android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "Tnorm, bgin th test list\n");
// #endif
...
// #ifdef __ANDROID_API__
// 			__android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "findEntityInNorm SEG[%s]\n", seg.c_str());
// #endif
...
#ifdef __ANDROID_API__
				__android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "tnorm impostor score not found for seg[%s]\n", seg.c_str());
#endif
...
// #ifdef __ANDROID_API__
// 	      __android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "tnorm distrib\n");
// #endif
...
// #ifdef __ANDROID_API__
// 		__android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "Compute Znorm\n");
// #endif
...
// #ifdef __ANDROID_API__
// 			__android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "Compute Znorm [%s]\n", id.c_str());
// #endif
...
#ifdef __ANDROID_API__
				__android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "znorm impostor score not found for id[%s]\n", id.c_str());
#endif
...
// #ifdef __ANDROID_API__
// 		__android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "znorm distrib\n");
// #endif
...
// #ifdef __ANDROID_API__
// 		__android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "Compute ZTnorm (and tnorm)\n");
// #endif
		...
		if (verbose) cout << "Computing once the Tnorm distribution for impostor segments"<<endl<<
							 "Take Care, really faster if the score files are sorted!"<<endl;
// #ifdef __ANDROID_API__
// 		__android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "Computing once the Tnorm distribution for impostor segments\n Take Care, really faster if the score files are sorted!\n");
// #endif
...
// #ifdef __ANDROID_API__
// 	    __android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "Computing once all the tnorm distributions for the test segments \n Take Care, really faster if the score files are sorted!\n");
// #endif
...
// #ifdef __ANDROID_API__
// 			__android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "ztnorm seg[%s]\n",id.c_str());
// #endif
...
#ifdef __ANDROID_API__
			__android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "tnorm impostor distribution not found for seg[%s]\n",seg.c_str());
#endif
...
#ifdef __ANDROID_API__
				__android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "ztnorm(tnormed) distribution not found for id[%s]\n",id.c_str());
#endif
...
// #ifdef __ANDROID_API__
// 		__android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "Compute TZnorm\n");
// #endif
...
// #endif
			...
			cout << "znorm distrib" << endl;
// #ifdef __ANDROID_API__
// 			__android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "ztnorm distrib\n");
// #endif

		   	znorm.print();    
		    cout << "tznorm distrib" << endl;
#ifdef __ANDROID_API__
			__android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "tztnorm distrib\n");
#endif
...
// #ifdef __ANDROID_API__
// 		__android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "begin the test list\n");
// #endif
...
// #ifdef __ANDROID_API__
// 			__android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "tznorm seg[%s] Id[%s]\n",seg.c_str(), id.c_str());
// #endif
...
#ifdef __ANDROID_API__
				__android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "ztnorm distribution not found for id[%s]\n",id.c_str());
#endif
...
#ifdef __ANDROID_API__
				__android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "tnorm(znormed) distribution not found for seg[%s]\n",seg.c_str());
#endif
...
#ifdef __ANDROID_API__
		  __android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "unknown normalization mode \n");
#endif
...
#ifdef __ANDROID_API__
		__android_log_print(ANDROID_LOG_DEBUG, "CompNorm", "Exception[%s]\n",e.toString().c_str());
#endif
